 ...
 */
public class StationaryMovement2 extends MovementModel {
	 ...
	 */
	public StationaryMovement2(Settings s) {
		super(s);
		//int coords[];
	 ...
	 */
	public StationaryMovement2(StationaryMovement2 sm) {
		super(sm);
		this.loc = sm.loc;
	}
	...
	@Override
	public StationaryMovement2 replicate() {
		return new StationaryMovement2(this);
	}
