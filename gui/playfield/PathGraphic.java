...
public class PathGraphic extends PlayFieldGraphic {
	...
	public void draw(Graphics2D g2) {
		...
		for (int i=1, n=coords.size(); i < n; i++) {
			...
			//pagdisplay han mga endpoints/segments(coordinates) han hostPath
//			g2.drawString(prev.toString(), scale(prev.getX()), scale(prev.getY()));
//			g2.drawString(next.toString(), scale(next.getX()), scale(next.getY()));
			//hahahahahahahah ez
